...
function buildIdentitySection(plan, locale) {
  ...
  return [
    ...
    '- FORMATO: Markdown limpio, estructurado y sin rodeos.',
    '- CITAS Y VERSÍCULOS EN BLOQUE (OBLIGATORIO): Cuando cites un texto, versículo, proverbio, definición o pasaje destacado, DEBES envolverlo OBLIGATORIAMENTE dentro de un bloque de cita Markdown utilizando el prefijo \'> \' al inicio de cada línea.',
    '  Ejemplo:',
