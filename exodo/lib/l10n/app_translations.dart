...
const Map<String, String> _es = <String, String>{
  ...
  'artifacts.empty_title': 'Sin expedientes',
  'artifacts.empty_desc': 'Cuando generes un artefacto (código, tabla, HTML o diagrama) en el chat, puedes pulsar "Compartir enlace Web" para publicarlo aquí y compartirlo con colegas.',
  'artifacts.back_chat': 'VOLVER AL CHAT',
  'artifacts.delete_title': '¿Eliminar enlace público?',
  'artifacts.delete_content': 'El enlace dejará de ser accesible para cualquier persona en internet.',
...
const Map<String, String> _en = <String, String>{
  ...
  'artifacts.empty_title': 'No records yet',
  'artifacts.empty_desc': 'When you generate an artifact (code, table, HTML or diagram) in chat, tap "Share Web Link" to publish it here and share with colleagues.',
  'artifacts.back_chat': 'BACK TO CHAT',
  'artifacts.delete_title': 'Delete public link?',
  'artifacts.delete_content': 'This link will no longer be accessible to anyone on the internet.',
