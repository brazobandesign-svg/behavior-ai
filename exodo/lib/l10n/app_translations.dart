...
const Map<String, String> _es = <String, String>{
  ...
  'billing.feat2': 'Razonamiento avanzado ilimitado XPi',
  ...
  'billing.feat4': 'Soporte prioritario y acceso anticipado',
...
const Map<String, String> _en = <String, String>{
  ...
  'billing.feat2': 'Unlimited XPi advanced reasoning',
  'billing.feat3': 'Priority access to Nemotron 3 Ultra',
  ...
  'billing.feat4': 'Priority support & early access',
...
const Map<String, String> _fr = <String, String>{
  ...
  'billing.feat4': 'Support prioritaire et accès anticipé',
...
const Map<String, String> _pt = <String, String>{
  ...
  'billing.feat4': 'Suporte prioritário e acesso antecipado',
...
const Map<String, String> _it = <String, String>{
  ...
  'billing.feat4': 'Supporto prioritario e accesso anticipato',
...
final Map<String, String> _ru = <String, String>{
  ...
  'billing.feat4': 'Приоритетная поддержка и ранний доступ',
...
final Map<String, String> _zh = <String, String>{
  ...
  'billing.feat2': '无限 XPi 高级推理',
  'billing.feat3': '优先访问 Nemotron 3 Ultra',
...
final Map<String, String> _ja = <String, String>{
  ...
  'billing.feat2': '無制限のXPi高度な推論',
  'billing.feat3': 'Nemotron 3 Ultraへの優先アクセス',
...
final Map<String, String> _ar = <String, String>{
  ...
  'billing.feat3': 'وصول أولوية إلى Nemotron 3 Ultra',
  ...
  'billing.feat4': 'دعم ذو أولوية ووصول مبكر',
...
final Map<String, String> _ko = <String, String>{
  ...
  'billing.feat2': '무제한 XPi 고급 추론',
  'billing.feat3': 'Nemotron 3 Ultra 우선 액세스',
...
final Map<String, String> _hi = <String, String>{
  ...
  'billing.feat3': 'Nemotron 3 Ultra तक प्राथमिकता पहुंच',
  ...
  'billing.feat4': 'प्राथमिकता समर्थन और प्रारंभिक पहुंच',
...
final Map<String, String> _ht = <String, String>{
  ...
  'billing.feat3': 'Aksè priyoritè ak Nemotron 3 Ultra',
  ...
  'billing.feat4': 'Sipò priyoritè ak aksè alavans',
