...
const Map<String, String> _es = <String, String>{
  ...
  'models.g11_desc': 'Modelo capaz para tareas diarias.',
  'models.xpi_desc': 'Razonamiento avanzado para tareas exigentes.',
  ...
  'drawer.shared_artifacts': 'Expedientes',

  // Artifacts / Expedientes screen
  'artifacts.title': 'Expedientes',
  'artifacts.refresh': 'Actualizar lista',
  'artifacts.error_title': 'Error de sincronización',
  'artifacts.error_msg': 'No se pudieron cargar tus expedientes. Revisa tu conexión a internet.',
  'artifacts.retry': 'REINTENTAR',
  'artifacts.empty_title': 'Tu archivo está vacío',
  'artifacts.empty_desc': 'Los documentos, tablas y aplicaciones interactivas que guardes desde tus conversaciones aparecerán aquí organizados para consultarlos o exportarlos.',
  'artifacts.back_chat': 'IR AL CHAT',
  'artifacts.guest_title': 'Solo para cuentas Éxodo',
  'artifacts.guest_desc': 'Crea una cuenta o inicia sesión para guardar tus expedientes y consultarlos desde cualquier dispositivo.',
  'artifacts.delete_title': '¿Eliminar expediente?',
  'artifacts.delete_content': 'Este expediente se eliminará permanentemente de tu archivo.',
  'artifacts.copied': 'Enlace copiado',
  'artifacts.deleted': 'Expediente eliminado exitosamente.',
  'artifacts.delete_failed': 'No se pudo eliminar el expediente. Intenta de nuevo.',
  'artifacts.search_empty': 'No se encontró ningún expediente con "{query}"',
  'artifacts.clear_search': 'Limpiar búsqueda',
  'artifacts.views': 'vistas',
  'artifacts.view': 'vista',
  'artifacts.published': 'Publicado',
  'artifacts.share_text': 'Consulta este recurso en Éxodo',
  'artifacts.filter_all': 'Todos',
  'artifacts.filter_docs': 'Documentos',
  'artifacts.filter_tables': 'Rúbricas & Tablas',
  'artifacts.filter_interactive': 'Interactivos',
  'artifacts.export_docx': 'DOCX',
  'artifacts.export_pdf': 'PDF',
  'artifacts.export_xlsx': 'XLSX',
  'artifacts.open_fullscreen': 'Abrir',
  'artifacts.share_web': 'Web Link',
  // [Punto 5] Commits de artefactos a GitHub
  'github.sheet_title': 'Commitear a GitHub',
  'github.sheet_desc': 'Publica este artefacto como archivo en tu repositorio. Todo se revisa antes de confirmar.',
  'github.repo_hint': 'propietario/repositorio o URL de GitHub',
  'github.path_hint': 'Ruta del archivo, ej. src/artifacts/app.html',
  'github.msg_hint': 'Mensaje del commit',
  'github.branch_hint': 'Rama (por defecto main)',
  'github.pat_hint': 'Personal Access Token de GitHub (opcional)',
  'github.link_btn': 'Enlazar cuenta / usar PAT',
  'github.commit_btn': 'CONFIRMAR COMMIT',
  'github.success': '¡Archivo commiteado!',
  'github.error': 'No se pudo commitear. Revisa los datos y tu conexión.',
  'github.link_required': 'Enlaza tu cuenta: entra con GitHub o pega un PAT con scope repo.',
  // [Punto 7] Acciones del artefacto sin español hardcodeado
  'artifacts.action_preview': 'Vista previa',
  'artifacts.action_save': 'Guardar en Expedientes',
  'artifacts.action_saving': 'Guardando...',
  'artifacts.action_saved': 'Guardado',
  'github.commit_chip': 'Commitear a GitHub',
  'artifacts.export_desc_web': 'Genera una URL pública interactiva en exodo.app',
  'artifacts.export_desc_pdf': 'Maquetado limpio para lectura e impresión',
  'artifacts.export_desc_docx': 'Documento Word con títulos y estructura nativa',
  'artifacts.export_desc_xlsx': 'Hoja de cálculo con celdas formateadas',
  'artifacts.export_desc_html': 'Archivo HTML independiente sanitizado',
  'artifacts.tab_preview': 'Vista previa',
  'artifacts.tab_code': 'Código',
  'artifacts.tooltip_export': 'Exportar archivo',
  'artifacts.no_preview_desc': 'Este artefacto no tiene una vista previa interactiva.\nAbre la pestaña Código para inspeccionarlo.',
  'artifacts.search_hint': 'Buscar en expedientes...',
  'artifacts.table_empty': 'Tabla sin datos detectables.',
  'artifacts.export_sheet_title': 'Exportar artefacto',
  'artifacts.export_sheet_desc': 'Elige un formato. El archivo se generará y se abrirá el menú de compartir.',
  'artifacts.export_na': 'Esta opción no aplica a este artefacto.',
  'artifacts.error_export': 'Error al exportar',
  'artifacts.web_link_failed': 'No se pudo generar el enlace web.',
  'artifacts.error_publish': 'Error al publicar enlace',
  'artifacts.generating_link': 'Generando enlace web público...',
  'artifacts.original_chat_missing': 'Conversación original no disponible.',
  'artifacts.error_share': 'Error al compartir',
  ...
  'settings.support_desc': '¿Tienes dudas, quejas, sugerencias o comentarios? Escríbenos directamente y te responderemos lo antes posible:',
  'settings.support_send': 'Enviar correo',
  'settings.support_copy': 'Copiar correo',
  'settings.support_copied': 'Correo copiado al portapapeles',
  ...
  'billing.plan_free': '⚡ G1.1 Gratis',
  'billing.gateway': 'Pasarela de pago',
  'billing.gateway_free': 'Gratuito',
  'billing.cancel_snack': 'ℹ️ Has regresado al plan G1.1 Gratis',
  'billing.cancel_btn': 'Cancelar suscripción',
  'billing.upgrade_btn': 'Mejorar a XPi Pro',
  ...
  'billing.not_available_yet':
      'Los pagos llegan pronto. Por ahora puedes seguir explorando G1.1.',
  ...
  'billing.feat3': 'Chatea en web, iOS y Android',
  ...
  'billing.feat7': 'Generación de imágenes ampliada: más imágenes que en el plan Gratis',
  'billing.no_commitments': 'Sin compromisos - Cancela cuando quieras',
  'billing.save_pct': 'Ahorra 16.5%',
  'billing.up_to_80_off': 'Hasta 80% off',
  'billing.out_of_service': 'Fuera de servicio',
...
const Map<String, String> _en = <String, String>{
  ...
  'models.g11_desc': 'Capable model for everyday tasks.',
  'models.xpi_desc': 'Advanced reasoning for demanding tasks.',
  ...
  'drawer.shared_artifacts': 'Records',

  // Artifacts / Records screen
  'artifacts.title': 'Records',
  'artifacts.refresh': 'Refresh list',
  'artifacts.error_title': 'Sync Error',
  'artifacts.error_msg': 'Could not load your records. Please check your internet connection.',
  'artifacts.retry': 'RETRY',
  'artifacts.empty_title': 'Your archive is empty',
  'artifacts.empty_desc': 'Documents, tables, and interactive apps you save from your conversations will appear here organized for quick review or export.',
  'artifacts.back_chat': 'GO TO CHAT',
  ...
  'artifacts.delete_title': 'Delete record?',
  'artifacts.delete_content': 'This record will be permanently deleted from your archive.',
  'artifacts.copied': 'Link copied',
  'artifacts.deleted': 'Record deleted successfully.',
  'artifacts.delete_failed': 'Could not delete record. Please try again.',
  ...
  'artifacts.share_text': 'Check this resource on Exodo',
  'artifacts.filter_all': 'All',
  'artifacts.filter_docs': 'Documents',
  'artifacts.filter_tables': 'Rubrics & Tables',
  'artifacts.filter_interactive': 'Interactive',
  'artifacts.export_docx': 'DOCX',
  'artifacts.export_pdf': 'PDF',
  'artifacts.export_xlsx': 'XLSX',
  'artifacts.open_fullscreen': 'Open',
  'artifacts.share_web': 'Web Link',
  // [Punto 5] Artifact commits to GitHub
  ...
  // [Punto 7] Artifact actions — no hardcoded Spanish
  'artifacts.action_preview': 'Preview',
  'artifacts.action_save': 'Save to Records',
  'artifacts.action_saving': 'Saving...',
  'artifacts.action_saved': 'Saved',
  'github.commit_chip': 'Commit to GitHub',
  'artifacts.export_desc_web': 'Generates an interactive public URL on exodo.app',
  'artifacts.export_desc_pdf': 'Clean layout for reading and printing',
  'artifacts.export_desc_docx': 'Word document with native headings and structure',
  'artifacts.export_desc_xlsx': 'Spreadsheet with formatted cells',
  'artifacts.export_desc_html': 'Self-contained sanitized HTML file',
  'artifacts.tab_preview': 'Preview',
  'artifacts.tab_code': 'Code',
  'artifacts.tooltip_export': 'Export file',
  'artifacts.no_preview_desc': 'This artifact has no interactive preview.\nOpen the Code tab to inspect it.',
  'artifacts.search_hint': 'Search records...',
  'artifacts.table_empty': 'Table without detectable data.',
  'artifacts.export_sheet_title': 'Export artifact',
  'artifacts.export_sheet_desc': 'Choose a format. The file will be generated and the share menu will open.',
  'artifacts.export_na': "This option doesn't apply to this artifact.",
  'artifacts.error_export': 'Error exporting',
  'artifacts.web_link_failed': "Couldn't generate the web link.",
  'artifacts.error_publish': 'Error publishing link',
  'artifacts.generating_link': 'Generating public web link...',
  'artifacts.original_chat_missing': 'Original conversation unavailable.',
  'artifacts.error_share': 'Error sharing',
  ...
  'settings.support_desc': 'Have questions, complaints, feedback, or suggestions? Write to us directly and we will get back to you as soon as possible:',
  'settings.support_send': 'Send email',
  'settings.support_copy': 'Copy email',
  'settings.support_copied': 'Email copied to clipboard',
  ...
  'billing.plan_free': '⚡ G1.1 Free',
  'billing.gateway': 'Payment gateway',
  'billing.gateway_free': 'Free',
  'billing.cancel_snack': 'ℹ️ You have returned to G1.1 Free plan',
  'billing.cancel_btn': 'Cancel subscription',
  'billing.upgrade_btn': 'Upgrade to XPi Pro',
  ...
  'billing.not_available_yet':
      'Payments are coming soon. For now you can keep exploring G1.1.',
  ...
  'billing.feat3': 'Chat across web, iOS, and Android',
  ...
  'billing.feat7': 'Extended image generation: more images than the Free plan',
  'billing.no_commitments': 'No commitments - Cancel anytime',
  'billing.save_pct': 'Save 16.5%',
  'billing.up_to_80_off': 'Up to 80% off',
  'billing.out_of_service': 'Unavailable',
...
const Map<String, String> _fr = <String, String>{
  ...
  'chat.placeholder_en': 'Reply to Exodo...',
  'chat.edit_message': 'Modifier le message',
  'chat.thinking': 'Exodo réfléchit...',
  'chat.thinking_en': 'Exodo reasoning...',
  'chat.thinking_label': 'Réflexion',
  'chat.creating_image': 'Éxodo crée votre image...',
  'models.g11_desc': 'Modèle performant pour les tâches quotidiennes.',
  'models.xpi_desc': 'Raisonnement avancé pour les tâches exigeantes.',
  ...
  'settings.support': 'Support',
  'settings.support_desc': 'Vous avez des questions, des réclamations, des messages ou des suggestions ? Écrivez-nous directement et nous vous répondrons dès que possible :',
  'settings.support_send': 'Envoyer un e-mail',
  'settings.support_copy': 'Copier l\'e-mail',
  'settings.support_copied': 'E-mail copié dans le presse-papiers',
  ...
  'billing.feat3': 'Discutez sur le web, iOS et Android',
  'billing.gateway': 'Portail d\'abonnement Exodo (Mode simulation)',
  'billing.gateway_free': 'Votre abonnement est actif.',
  'billing.not_available_yet':
      'Les paiements arrivent bientôt. Pour l\'instant, continuez à explorer G1.1.',
  ...
  'billing.feat7': 'Génération d\'images étendue : plus d\'images que le plan Gratuit',
  'billing.no_commitments': 'Sans engagement - Annulez à tout moment',
  'billing.save_pct': 'Économisez 16.5%',
  'billing.up_to_80_off': "Jusqu'à -80%",
  'billing.out_of_service': 'Indisponible',
...
const Map<String, String> _pt = <String, String>{
  ...
  'models.g11_desc': 'Modelo capaz para tarefas diárias.',
  'models.xpi_desc': 'Raciocínio avançado para tarefas exigentes.',
  ...
  'settings.support_desc': 'Tem dúvidas, reclamações, mensagens ou sugestões? Escreva diretamente para nós e responderemos o mais breve possível:',
  'settings.support_send': 'Enviar e-mail',
  'settings.support_copy': 'Copiar e-mail',
  'settings.support_copied': 'E-mail copiado para a área de transferência',
  ...
  'billing.feat3': 'Converse na web, iOS e Android',
  'billing.gateway': 'Portal de Assinatura Exodo (Modo Simulação)',
  'billing.gateway_free': 'Sua assinatura está ativa.',
  'billing.not_available_yet':
      'Os pagamentos chegam em breve. Por enquanto, continue explorando o G1.1.',
  ...
  'billing.feat7': 'Geração de imagens ampliada: mais imagens que no plano Grátis',
  'billing.no_commitments': 'Sem compromisso - Cancele quando quiser',
  'billing.save_pct': 'Economize 16.5%',
  'billing.up_to_80_off': 'Até 80% off',
  'billing.out_of_service': 'Indisponible',
...
const Map<String, String> _it = <String, String>{
  ...
  'models.g11_desc': 'Modello capace per compiti quotidiani.',
  'models.xpi_desc': 'Ragionamento avanzato per compiti complessi.',
  ...
  'settings.support_desc': 'Hai domande, reclami, messaggi o suggerimenti? Scrivici direttamente e ti risponderemo il prima possibile:',
  'settings.support_send': 'Invia email',
  'settings.support_copy': 'Copia email',
  'settings.support_copied': 'Email copiata negli appunti',
  ...
  'billing.feat3': 'Chatta su web, iOS e Android',
  'billing.gateway': 'Portale abbonamento Exodo (Modalità simulazione)',
  'billing.gateway_free': 'Il tuo abbonamento è attivo.',
  'billing.not_available_yet':
      'I pagamenti arriveranno presto. Per ora puoi continuare a esplorare G1.1.',
  ...
  'billing.feat7': 'Generazione di immagini estesa: più immagini del piano Gratuito',
  'billing.no_commitments': 'Senza impegno - Cancella in qualsiasi momento',
  'billing.save_pct': 'Risparmia il 16.5%',
  'billing.up_to_80_off': 'Fino all\'80% di sconto',
  'billing.out_of_service': 'Non disponibile',
...
const Map<String, String> _de = <String, String>{
  ...
  'models.g11_desc': 'Leistungsfähiges Modell für alltägliche Aufgaben.',
  'models.xpi_desc': 'Fortgeschrittene Logik für anspruchsvolle Aufgaben.',
  ...
  'settings.support': 'Support',
  'settings.support_desc': 'Haben Sie Fragen, Beschwerden, Nachrichten oder Anregungen? Schreiben Sie uns direkt und wir antworten so schnell wie möglich:',
  'settings.support_send': 'E-Mail senden',
  'settings.support_copy': 'E-Mail kopieren',
  'settings.support_copied': 'E-Mail in die Zwischenablage kopiert',
  ...
  'billing.feat3': 'Chat auf Web, iOS und Android',
  'billing.gateway': 'Exodo-Abonnement-Portal (Simulationsmodus)',
  'billing.gateway_free': 'Ihr Abonnement ist aktiv.',
  'billing.not_available_yet':
      'Zahlungen kommen bald. Vorerst kannst du G1.1 weiter erkunden.',
  ...
  'widget.square_genesis': 'G1.1 Quadrat',
  ...
  'billing.feat7': 'Erweiterte Bildgenerierung: mehr Bilder als im Gratis-Tarif',
  'billing.no_commitments': 'Keine Verpflichtung - Jederzeit kündbar',
  'billing.save_pct': '16.5% sparen',
  'billing.up_to_80_off': 'Bis zu 80% Rabatt',
  'billing.out_of_service': 'Non disponibile',
...
final Map<String, String> _ru = <String, String>{
  ...
  'chat.placeholder_en': 'Reply to Exodo...',
  'chat.edit_message': 'Редактировать сообщение',
  'chat.thinking': 'Exodo думает...',
  'chat.thinking_en': 'Exodo reasoning...',
  'chat.thinking_label': 'Думаю',
  'chat.creating_image': 'Éxodo создает ваше изображение...',
  'models.g11_desc': 'Способная модель для ежедневных задач.',
  'models.xpi_desc': 'Продвинутое мышление для сложных задач.',
  ...
  'settings.support_desc': 'У вас есть вопросы, жалобы, сообщения или предложения? Напишите нам, и мы ответим как можно скорее:',
  'settings.support_send': 'Написать письмо',
  'settings.support_copy': 'Скопировать email',
  'settings.support_copied': 'Email скопирован в буфер обмена',
  ...
  'billing.feat3': 'Общение на вебе, iOS и Android',
  'billing.gateway': 'Портал подписки Exodo (Режим симуляции)',
  'billing.gateway_free': 'Ваша подписка активна.',
  'billing.not_available_yet':
      'Платежи скоро появятся. Пока вы можете продолжать изучать G1.1.',
  ...
  'billing.feat7': 'Расширенная генерация изображений: больше, чем в бесплатном плане',
  'billing.no_commitments': 'Без обязательств — отмена в любое время',
  'billing.save_pct': 'Экономия 16.5%',
  'billing.up_to_80_off': 'Скидка до 80%',
  'billing.out_of_service': 'Недоступно',
...
final Map<String, String> _zh = <String, String>{
  ...
  'models.g11_desc': '适用于日常任务的高效模型。',
  'models.xpi_desc': '适用于严苛任务的高级推理模型。',
  ...
  'settings.support': '支持',
  'settings.support_desc': '您有任何疑问、投诉、留言或建议吗？请直接发送邮件给我们，我们将尽快回复：',
  'settings.support_send': '发送邮件',
  'settings.support_copy': '复制邮箱',
  'settings.support_copied': '邮箱已复制到剪贴板',
  ...
  'billing.feat3': '支持网页、iOS 和 Android 聊天',
  ...
  'widget.horiz_genesis': '卧式 G1.1',
  'widget.pick_format': '选择主屏幕小组件的格式：',
  'widget.quick_search': '快速搜索',
  'widget.square_genesis': '方形 G1.1',
  ...
  'billing.feat7': '扩展图像生成：比免费方案更多图像',
  'billing.no_commitments': '无绑定合约 — 随时取消',
  'billing.save_pct': '节省 16.5%',
  'billing.up_to_80_off': '高达80%折扣',
  'billing.out_of_service': '暂不可用',
...
final Map<String, String> _ja = <String, String>{
  ...
  'models.g11_desc': '日常タスクに適した有能なモデル。',
  'models.xpi_desc': '要求の厳しいタスク向けの高度な推論。',
  ...
  'settings.support_desc': 'ご質問、苦情、メッセージ、ご要望などがございましたら、直接メールでお問い合わせください。できる限り迅速にご返信いたします：',
  'settings.support_send': 'メールを送信',
  'settings.support_copy': 'メールをコピー',
  'settings.support_copied': 'メールアドレスをクリップボードにコピーしました',
  ...
  'billing.feat3': 'Web、iOS、Androidでチャット',
  ...
  'widget.horiz_genesis': 'ホリゾンタル G1.1',
  'widget.pick_format': 'ホーム画面のフォーマットを選択：',
  'widget.quick_search': 'クイック検索',
  'widget.square_genesis': 'スクエア G1.1',
  ...
  'billing.feat7': '画像生成を拡張：無料プランより多くの画像',
  'billing.no_commitments': '契約縛りなし — いつでもキャンセル可能',
  'billing.save_pct': '16.5%お得',
  'billing.up_to_80_off': '最大80%オフ',
  'billing.out_of_service': '現在利用不可',
...
final Map<String, String> _ar = <String, String>{
  ...
  'models.g11_desc': 'نموذج قادر على إنجاز المهام اليومية.',
  'models.xpi_desc': 'تفكير متقدم للمهام الصعبة والمطالبة.',
  ...
  'settings.support_desc': 'هل لديك أي أسئلة أو شكاوى أو رسائل أو اقتراحات؟ راسلنا مباشرة وسنرد عليك في أقرب وقت:',
  'settings.support_send': 'إرسال بريد',
  'settings.support_copy': 'نسخ البريد',
  'settings.support_copied': 'تم نسخ البريد الإلكتروني إلى الحافظة',
  ...
  'billing.feat3': 'الدردشة عبر الويب و iOS و Android',
  ...
  'billing.feat7': 'توليد صور موسّع: صور أكثر من الخطة المجانية',
  'billing.no_commitments': 'بدون التزامات — إلغاء في أي وقت',
  'billing.save_pct': 'توفير 16.5%',
  'billing.up_to_80_off': 'خصم يصل إلى 80%',
  'billing.out_of_service': 'غير متوفر',
...
final Map<String, String> _ko = <String, String>{
  ...
  'models.g11_desc': '일상적인 작업을 위한 유능한 모델.',
  'models.xpi_desc': '까다로운 작업을 위한 고급 추론 모델.',
  ...
  'settings.support_desc': '질문, 불만 사항, 메시지 또는 제안이 있으신가요? 직접 문의해 주시면 최대한 빨리 답변해 드리겠습니다:',
  'settings.support_send': '이메일 보내기',
  'settings.support_copy': '이메일 복사',
  'settings.support_copied': '이메일이 클립보드에 복사되었습니다',
  ...
  'billing.feat3': '웹, iOS, Android에서 채팅',
  ...
  'billing.feat7': '확장된 이미지 생성: 무료 플랜보다 더 많은 이미지',
  'billing.no_commitments': '약정 없음 — 언제든 취소 가능',
  'billing.save_pct': '16.5% 절약',
  'billing.up_to_80_off': '최대 80% 할인',
  'billing.out_of_service': '이용 불가',
...
final Map<String, String> _hi = <String, String>{
  ...
  'models.g11_desc': 'दैनिक कार्यों के लिए सक्षम मॉडल।',
  'models.xpi_desc': 'कठिन कार्यों के लिए उन्नत तर्क।',
  ...
  'settings.support_desc': 'क्या आपके पास कोई प्रश्न, शिकायत, संदेश या सुझाव है? हमें सीधे ईमेल करें और हम जल्द से जल्द उत्तर देंगे:',
  'settings.support_send': 'ईमेल भेजें',
  'settings.support_copy': 'ईमेल कॉपी करें',
  'settings.support_copied': 'ईमेल क्लिपबोर्ड पर कॉपी हो गया',
  ...
  'billing.feat3': 'वेब, iOS और Android पर चैट',
  ...
  'billing.feat7': 'विस्तारित इमेज जनरेशन: फ्री प्लान से अधिक इमेज',
  'billing.no_commitments': 'कोई प्रतिबद्धता नहीं — कभी भी रद्द करें',
  'billing.save_pct': '16.5% बचाएं',
  'billing.up_to_80_off': '80% तक छूट',
  'billing.out_of_service': 'अनुपलब्ध',
...
final Map<String, String> _ht = <String, String>{
  ...
  'models.g11_desc': 'Modèl pèfòman pou travay chak jou.',
  'models.xpi_desc': 'Rezònman avanse pou travay ki mande anpil.',
  ...
  'greeting.late': 'Menm lannwit pa ka stope w',
  'greeting.morning_en': 'Morning',
  'greeting.afternoon_en': 'Afternoon',
  'greeting.evening_en': 'Evening',
  'greeting.late_en': 'Late night hustle',
  'greeting.cold': 'Fredi deyò, pi bon pase yon kafe',
  'greeting.hot': 'Pran yon bagay frèt, fè twò cho',
  'greeting.cold_en': 'Cold outside, better than coffee',
  'greeting.hot_en': 'Grab something cold, really hot',
  'drawer.new_chat': 'Nouvo konvèsasyon',
  'drawer.search_chats': 'Chèche',
  'drawer.starred': 'Mete anlè',
  'drawer.recents': 'Dènye yo',
  'drawer.incognito': 'Mòd Enkoyito',
  'drawer.light_mode': 'Mòd Klè',
  'drawer.dark_mode': 'Mòd Nwa',
  'drawer.sign_in': 'Konekte',
  'drawer.sign_out': 'Dekonekte',
  'drawer.upgrade': 'Pase nan Pro',
  'drawer.language': 'Lang',
  'drawer.add_widget': 'Ajoute yon widget sou ekran lakay ou',
  'ctx.rename': 'Chanje non',
  'ctx.pin': 'Mete anlè',
  'ctx.unpin': 'Retire anlè',
  'ctx.delete': 'Efase',
  'ctx.cancel': 'Anile',
  'act.copy': 'Kopye',
  'act.share': 'Pataje',
  'act.play': 'Koute',
  'act.like': 'M renmen',
  'act.dislike': 'M pa renmen',
  'act.recharge': 'Refè',
  'live.coming_soon':
      'Chat an dirèk ap vini byento — ekri yon mesaj pou kòmanse.',
  'mic.permission_required':
      '⚠️ Ou bezwen pèmisyon mikro a pou dikte vwa a.',
  'tts.playing': '🔊 Ap li...',
  'tts.unsupported': '⚠️ Vwa atifisyèl pa disponib sou aparèy sa a.',
  'tts.empty': 'Pa gen anyen pou li.',
  'sources.title': 'Sous',
  'sources.title_en': 'Sources',
  'tokens.used': 'Itilize',
  ...
  'lang.sheet_subtitle': 'Chwazi lang ou prefere a',
  'lang.system': 'Deteksyon Otomatik',
  'code.copy': 'Kopye',
  'code.copied': 'Kopye !',
  'starter.1': 'Rezime nouvèl jodi a',
  'starter.2': 'Eksplike yon konsèp konplèks',
  'starter.3': 'Ekri yon imèl pwofesyonèl',
  'starter.4': 'Lide pou yon pwoje inovatè',
  'settings.profile': 'Pwofil',
  'settings.billing': 'Abònman ak Plan',
  'settings.logout': 'Dekonekte',
  'settings.support': 'Sipò',
  'settings.support_desc': 'Ou gen kesyon, plent, mesaj oswa sijesyon? Ekri nou dirèkteman epi n ap reponn ou pi vit posib:',
  'settings.support_send': 'Voye imèl',
  'settings.support_copy': 'Kopye imèl',
  'settings.support_copied': 'Imèl kopye nan papye',
  'settings.terms': 'Tèm ak Konfidansyalite',
  'settings.no_email': 'Sesyon san imèl',
  'action.close': 'Fèmen',
  'action.save': 'Sove',
  'action.send': 'Voye',
  'attach.camera': 'Kamera',
  'attach.files': 'Dokiman',
  'attach.gallery': 'Galeri',
  'auth.coming_soon_apple': 'Byento : Koneksyon ak Apple',
  'auth.coming_soon_github': 'Byento : Koneksyon ak GitHub',
  'auth.coming_soon_x': 'Byento : Koneksyon ak X / Twitter',
  'billing.activated': '🎉 Plan XPi PRO aktive avèk siksè !',
  'billing.cancel_btn': 'Anile abònman an',
  'billing.cancel_snack':
      'Abònman an anile. W ap kenbe plan Pro a jouk nan fen peryòd la.',
  'billing.current_plan': 'Plan ou kounye a',
  'billing.feat1': 'Tout sa ki nan plan Gratis la',
  'billing.feat2': 'Pli gwo limit pou itilize',
  'billing.feat3': 'Chat sou entènèt, iOS ak Android',
  ...
  'profile.save_error': 'Erè pandan sove a :',
  ...
  'billing.feat7': 'Jenerasyon imaj pwolonje: plis imaj pase plan Gratis la',
  'billing.no_commitments': 'San angajman — Anile nenpòt kilè',
  'billing.save_pct': 'Ekonomize 16.5%',
  'billing.up_to_80_off': 'Jiska 80% rabè',
  'billing.out_of_service': 'Pa disponib',
